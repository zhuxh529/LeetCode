...
public class BTreePrinterTest {
    ...
    public static Node<Integer> test3() {
        Node<Integer> root = new Node<Integer>(2);
        Node<Integer> n11 = new Node<Integer>(7);
        Node<Integer> n12 = new Node<Integer>(5);
        Node<Integer> n21 = new Node<Integer>(2);
    ...
    public static Node<Integer> test4() {
        Node<Integer> root = new Node<Integer>(5);
        Node<Integer> n11 = new Node<Integer>(4);
        Node<Integer> n12 = new Node<Integer>(4);
        Node<Integer> n21 = new Node<Integer>(3);
        Node<Integer> n22 = new Node<Integer>(6);
        Node<Integer> n23 = new Node<Integer>(6);
        Node<Integer> n24 = new Node<Integer>(3);
    ...
    public static Node<Integer> test5() {
    ...
    public static Node<Integer> test6() {
        Node<Integer> root = new Node<Integer>(1);
        Node<Integer> n11 = new Node<Integer>(2);
        Node<Integer> n12 = new Node<Integer>(10);
       
        Node<Integer> n21 = new Node<Integer>(-2);
        Node<Integer> n22 = new Node<Integer>(-4);
        Node<Integer> n23 = new Node<Integer>(10);
        Node<Integer> n24 = new Node<Integer>(10);
